...
public class SpriteController : UIBase
{
    Color TextColorSave;
    ...
    {
        return new FFRef<Color>(() => transform.GetComponent<SpriteRenderer>().color, (v) => { transform.GetComponent<SpriteRenderer>().color = v; });
    }
